...
export class KitDropdownToggle extends Component {
  render() {
    ...
    return (
      <StyledBootstrapDropdownToggle className={showMenu ? "dropdown-toggle show" : "dropdown-toggle"}
        { ...rest }
      />
    );
  }
  ...
  render() {
    ...
    return (
      <StyledBootstrapDropdownMenu
        className={`dropdown-menu ${alignRight ? "dropdown-menu-right" : ""} ${showMenu ? "show" : ""}`}
        {...rest}
      />
    );
  }
...
export function KitDropdown(props) {
  ...
  return (
    <StyledBootstrapDropdown show={showMenu} className={showMenu ? "show dropdown" : "dropdown"}
      { ...props }
    >
      <KitDropdownToggle                
